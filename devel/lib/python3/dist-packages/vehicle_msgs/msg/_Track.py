...
"""autogenerated by genpy from vehicle_msgs/Track.msg. Do not edit."""
import codecs
import sys
...
class Track(genpy.Message):
  ...
  _type = "vehicle_msgs/Track"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vehicle_msgs/TrackCone[] cones
================================================================================
...
string type"""
  __slots__ = ['cones']
  _slot_types = ['vehicle_msgs/TrackCone[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = vehicle_msgs.msg.TrackCone()
        _x = val1
        start = end
        end += 16
