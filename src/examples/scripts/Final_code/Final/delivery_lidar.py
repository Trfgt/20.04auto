...
class DELIVERY:
    ...
    def lidar_callback(self, _data):   
        ...
        if self.is_odom and self.Delivery_target_idx is not None and len(delivery_signs)>=3 and self.Delivery_End==True and self.vel==0 and self.utm_end == False: #본선
        # if self.is_odom and self.Delivery_target_idx is not None and len(delivery_signs)>=3 and self.Delivery_End==True and self.utm_end == False:
                ...
                if  302602.518019 < target_utm[0] <302605.654524 and 4124012.67445 < target_utm[1] < 4124094.88111:
                    self.utm_end = True
