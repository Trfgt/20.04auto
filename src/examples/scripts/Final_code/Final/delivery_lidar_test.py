...
class GPS2UTM:
    ...
    def lidar_callback(self, _data):   
        ...
        # self.vision_num =12
        self.Delivery_target_idx = 1  # 임의로 설정 
        ...
        for obj in _data.array:
            ...
            # 302475.1875,4123753.75 #34128073
        ...
        # if delivery_sign_cnt>=3 and (self.vision_num==21 or self.vision_num==22 or self.vision_num==23):
        if delivery_sign_cnt>=3 : # 플래너에 정지 명령 
            msg=True
            print("==============")
        ...
        if self.Delivery_End==True :
                ...
                self.UTM = [326571.285,4128137.732]
