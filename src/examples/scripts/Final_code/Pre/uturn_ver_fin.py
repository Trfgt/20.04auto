    ...
    def lidar_callback(self, _data):
        ...
        for i, obj in enumerate(obj):
            ...
            if(self.State=="Rubber_cone_drive"):
                ...
                if(0<=self.ROI_1st_cnt<15 and 0.4<bbox_center_x<7 and -1.2<bbox_center_y<1 and 0.03<bbox_width<0.25 and 0.1<bbox_height<0.4):  # RIGHT TURN 
                    self.a =True 
