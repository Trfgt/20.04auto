...
class GPS2UTM:
    def __init__(self):
        ...
        self.heading = None  # heading 변수를 초기화
        #----------------------------------------------
    ...
    def imu_callback(self, _data):
        ...
        self.heading = self.calculate_heading_from_imu()  # heading 값을 설정
        # print(f"Heading: {self.heading}")
        pass
    
    def lidar_callback(self, _data):
        if self.heading is None:  # heading 값이 초기화되지 않았다면 lidar_callback 종료
            return
