...
static SegmenterParams getSegmenterParams(const ros::NodeHandle& nh,
    ...
    //DBSCAN Segmenter 추가
    nh.param<double>(ns + "/dbscan_eps", params.dbscan_eps, 0.01);
    nh.param<int>(ns + "/dbscan_min_pts", params.dbscan_min_pts, 35);
    ...
    // brake_value
    nh.param<int>(ns + "/brake_value", params.brake_value, 14000);
    return params;
}
