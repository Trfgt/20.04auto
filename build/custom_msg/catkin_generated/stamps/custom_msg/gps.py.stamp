...
class GPS2UTM:
    def __init__(self):
        ...
        self.pub=rospy.Publisher("/PointArray", PointArray_msg, queue_size=10)
        #----------------변수 초기화---------------------
    ...
    def lidar_callback(self, _data):
        ...
        for i in range(total_obj_cnt):
            ...
            point_msg = Point()
            point_msg.x = end_utm_easting
            point_msg.y = end_utm_northing
            point_msg.z = 0.0  # Assuming z coordinate is 0 for simplicity
